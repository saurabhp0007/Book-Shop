    ...
    const handleLogin = () => {
        loginWithGoogle()
            .then((result) => {
                ...
                // Consider using a more user-friendly approach for success messages
        ...
        <div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
            <div className="relative py-3 sm:max-w-xl sm:mx-auto">
                    ...
                    <div className="max-w-md mx-auto">
                        ...
                        <div className="divide-y divide-gray-200">
                            <form onSubmit={handleSubmit} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                ...
                                <p>If you have not an Account please <Link to="/sign-up" className='text-blue-700 underline'>Sign-up</Link> Here</p>
                                <div className="relative">
                                    <button className="bg-blue-500 text-white rounded-md px-6 py-1" type="submit">Submit</button>
                                </div>
                            </form>
                ...
                <div className='flex w-full items-center flex-col mt-5 gap-3 '>
                    <button onClick={handleLogin} className='block'><img src={google} alt="" className='w-12 h-12 inline-block'  />Login with Google</button>
                </div>
                    </div>
                </div>
            </div>
